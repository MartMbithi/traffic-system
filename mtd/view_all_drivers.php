								...
								<tbody>
									...
									<tr> 
										<td> <!--consider about row and res when edit button add-->	
											<button type="button" name="view" value="View" id="<?php echo $row["driver_license_id"]; ?>" class="btn btn-info btn-xs view_data"><i class="fas fa-info-circle"></i></button>
											<button type="button" name="edit" value="Edit" id="<?php echo $row["driver_license_id"]; ?>" class="btn btn-success btn-xs edit_data"><i class="fas fa-pen"></i></button>
											<button type="button" name="delete" value="Delete" id="<?php echo $row["driver_license_id"]; ?>" class="btn btn-danger btn-xs delete_data"><i class="fas fa-trash-alt"></i></button>								
										</td>										
										<td><?php echo $row["driver_license_id"] ?></td>
										<td><?php echo $row["driver_email"] ?></td>
										<td><?php echo $row["driver_name"] ?></td>
										<td><?php echo $row["driver_license_issue_date"] ?></td>
										<td><?php echo $row["driver_license_expire_date"] ?></td>
